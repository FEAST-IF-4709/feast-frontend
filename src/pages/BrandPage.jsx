...
import brandHeroImg from '../assets/Kinetic Kitchen Action.jpg';
...
const BrandPage = () => {
  ...
  return (
    <LandingLayout>
        ...
        <div className="bg-white min-h-screen pt-32 pb-20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <motion.div initial="hidden" animate="visible" variants={fadeUp} className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-feast-dark-muted font-vietnam text-base lg:text-lg leading-relaxed max-w-lg mx-auto">
            ...
            {/* Hero Image */}
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="w-full h-64 md:h-96 rounded-[2rem] overflow-hidden mb-24 shadow-2xl relative group">
              <img 
                src={brandHeroImg} 
                alt="Brand Identity" 
      ...
      {/* ============================================= */}
      <section id="color-palette" className="bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="mb-16">
            ...
            <p className="text-feast-dark-muted font-vietnam text-base max-w-2xl">
              Colors designed to stimulate the appetite and evoke warmth. Our identity is built on motion, warmth, and precision. Explore the visual language of FEAST.
            </p>
          </motion.div>
